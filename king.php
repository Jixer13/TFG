            ...
            <div class="fullwidth-block inner-content">
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            <div class="widget">
                                <h3 class="widget-title">King Von</h3>
                                <form action="" method="GET">
                                    <br><br>
                                    <?php
                                        
                                        $consulta = $conn->query("SELECT biografia FROM cantantes WHERE nombre = 'King Von'");
                                        ...
                                        if (isset($resultado)) {
                                            ...
                                            echo "No se encontraron resultados para 'King Von'";
                                        }
                                    ...
                                    <table class="table-c">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><img class="img-canciones" src="JixerDaude\tookhertotheo.png" alt="KRUSH BANDICOOT"></td>
                                                <td>Took Her To The O<br>King Von</td>
                                                <td>Levon James</td>
                                            </tr>
                                            <tr>
                                                <td><b class="id">2<b></td>
                                                <td><img class="img-canciones" src="JixerDaude\crazystory.png" alt="BRRs"></td>
                                                <td>Crazy Story PT3<br>King Von</td>
                                                <td>Grandson, Vol.1</td>
                                            </tr>
                                            <tr>
                                                <td><b class="id">3</b></td>
                                                <td><img class="img-canciones" src="JixerDaude\ad.png" alt="UNA PALABRA"></td>
                                                <td>Armed & Dangerous<br>King Von</td>
                                                <td>Welcome to O'Block</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
