            ...
            <div class="fullwidth-block inner-content">
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            <div class="widget">
                                <h3 class="widget-title">Jon Z</h3>
                                <form action="" method="GET">
                                    <br><br>
                                    <?php
                                        
                                        $consulta = $conn->query("SELECT biografia FROM cantantes WHERE nombre = 'jonz'");
                                        ...
                                        if (isset($resultado)) {
                                            ...
                                            echo "No se encontraron resultados para 'Jon Z'";
                                        }
                                    ...
                                    <table class="table-c">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><img class="img-canciones" src="JixerDaude\pali2.png" alt="JonTrapVolta"></td>
                                                <td>Pali 2<br>Jon Z</td>
                                                <td>JonTrapVolta</td>
                                            </tr>
                                            <tr>
                                                <td><b class="id">2<b></td>
                                                <td><img class="img-canciones" src="JixerDaude\viajosinver.png" alt="BRRs"></td>
                                                <td>Viajo Sin Ver<br>Jon Z</td>
                                                <td>Viajo Sin Ver</td>
                                            </tr>
                                            <tr>
                                                <td><b class="id">3</b></td>
                                                <td><img class="img-canciones" src="JixerDaude\contigomelavivo.png" alt="Contigo me la vivo"></td>
                                                <td>Contigo me la vivo<br>Jon Z</td>
                                                <td>Contigo me la vivo</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
