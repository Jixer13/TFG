            ...
            <div class="fullwidth-block inner-content">
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            <div class="widget">
                                <h3 class="widget-title">Pop Smoke</h3>
                                <form action="" method="GET">
                                    <br><br>
                                    <?php
                                        
                                        $consulta = $conn->query("SELECT biografia FROM cantantes WHERE nombre = 'Pop Smoke'");
                                        ...
                                        if (isset($resultado)) {
                                            ...
                                            echo "No se encontraron resultados para 'Pop Smoke'";
                                        }
                                    ...
                                    <table class="table-c">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><img class="img-canciones" src="JixerDaude\meetthewoo.png" alt="KRUSH BANDICOOT"></td>
                                                <td>Dior<br>Pop Smoke</td>
                                                <td>Meet The Woo</td>
                                            </tr>
                                            <tr>
                                                <td><b class="id">2<b></td>
                                                <td><img class="img-canciones" src="JixerDaude\shoot.png" alt="BRRs"></td>
                                                <td>What You Know Bout Love<br>Pop Smoke</td>
                                                <td>Shoot For The Stars Aim For The Moon</td>
                                            </tr>
                                            <tr>
                                                <td><b class="id">3</b></td>
                                                <td><img class="img-canciones" src="JixerDaude\meetthewoo2.png" alt="UNA PALABRA"></td>
                                                <td>Invincible<br>Pop Smoke</td>
                                                <td>Meet The Wood 2</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
