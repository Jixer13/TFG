            ...
            <div class="fullwidth-block inner-content">
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            <div class="widget">
                                <h3 class="widget-title">Anuel AA</h3>
                                <form action="" method="GET">
                                    <br><br>
                                    <?php
                                        
                                        $consulta = $conn->query("SELECT biografia FROM cantantes WHERE nombre = 'Anuel'");
                                        ...
                                        if (isset($resultado)) {
                                            ...
                                            echo "No se encontraron resultados para 'Anuel'";
                                        }
                                    ...
                                    <table class="table-c">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><img class="img-canciones" src="JixerDaude\RHLM.png" alt="KRUSH BANDICOOT"></td>
                                                <td>Yeezy<br>Anuel AA</td>
                                                <td>RHML - Real Hasta La Muerte</td>
                                            </tr>
                                            <tr>
                                                <td><b class="id">2<b></td>
                                                <td><img class="img-canciones" src="JixerDaude\LLNM2.png" alt="BRRs"></td>
                                                <td>BRRR<br>Anuel AA</td>
                                                <td>LLNM 2 - Las Leyenedas Nunca Mueren 2</td>
                                            </tr>
                                            <tr>
                                                <td><b class="id">3</b></td>
                                                <td><img class="img-canciones" src="JixerDaude\LLNM.png" alt="UNA PALABRA"></td>
                                                <td>Una Palabra<br>Anuel AA</td>
                                                <td>LLNM - Las Leyendas Nunca Mueren</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
