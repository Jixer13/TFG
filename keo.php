            ...
            <div class="fullwidth-block inner-content">
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            <div class="widget">
                                <h3 class="widget-title">Kidd Keo</h3>
                                <form action="" method="GET">
                                    <br><br>
                                    <?php
                                        
                                        $consulta = $conn->query("SELECT biografia FROM cantantes WHERE nombre = 'Kidd Keo'");
                                    ...
                                    <table class="table-c">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><img class="img-canciones" src="JixerDaude\thegiant.png" alt="The Giant"></td>
                                                <td>Superstars<br>Kidd Keo</td>
                                                <td>The Giant</td>
                                            </tr>
                                            <tr>
                                                <td><b class="id">2<b></td>
                                                <td><img class="img-canciones" src="JixerDaude\mavie.png" alt="Rockport Espacial"></td>
                                                <td>Ma Vie<br>Kidd Keo</td>
                                                <td>Rockport Espacial</td>
                                            </tr>
                                            <tr>
                                                <td><b class="id">3</b></td>
                                                <td><img class="img-canciones" src="JixerDaude\comovas.png" alt="BACT TO ROCKPORT"></td>
                                                <td>Como vas?<br>Kidd keo</td>
                                                <td>BACK TO ROCKPORT</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
